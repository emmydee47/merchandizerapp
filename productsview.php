...
fproductsview.Lists["x_product_category"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"product_categories"};
fproductsview.Lists["x_product_category"].Data = "<?php echo $products_view->product_category->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($products->sn->Visible) { // sn ?>
	<tr id="r_sn">
		<td class="col-sm-2"><span id="elh_products_sn"><?php echo $products->sn->FldCaption() ?></span></td>
		<td data-name="sn"<?php echo $products->sn->CellAttributes() ?>>
<span id="el_products_sn">
<span<?php echo $products->sn->ViewAttributes() ?>>
<?php echo $products->sn->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($products->product_category->Visible) { // product_category ?>
	<tr id="r_product_category">
		<td class="col-sm-2"><span id="elh_products_product_category"><?php echo $products->product_category->FldCaption() ?></span></td>
...
<?php echo $products->product_category->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($products->product_name->Visible) { // product_name ?>
	<tr id="r_product_name">
		<td class="col-sm-2"><span id="elh_products_product_name"><?php echo $products->product_name->FldCaption() ?></span></td>
...
<?php if ($products->product_description->Visible) { // product_description ?>
	<tr id="r_product_description">
		<td class="col-sm-2"><span id="elh_products_product_description"><?php echo $products->product_description->FldCaption() ?></span></td>
...
<?php if ($products->price->Visible) { // price ?>
	<tr id="r_price">
		<td class="col-sm-2"><span id="elh_products_price"><?php echo $products->price->FldCaption() ?></span></td>
...
<?php if ($products->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_products_image"><?php echo $products->image->FldCaption() ?></span></td>
		<td data-name="image"<?php echo $products->image->CellAttributes() ?>>
<span id="el_products_image">
<span>
<?php echo ew_GetFileViewTag($products->image, $products->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
