...
class cproducts_list extends cproducts {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fproductslistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->product_id, $arKeywords, $type);
	...
	function RenderRow() {
		...
		$this->image->ViewCustomAttributes = "";
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "products_x" . $this->RowCnt . "_image";
...
fproductslist.Lists["x_product_category"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"product_categories"};
fproductslist.Lists["x_product_category"].Data = "<?php echo $products_list->product_category->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($products->sn->Visible) { // sn ?>
	<?php if ($products->SortUrl($products->sn) == "") { ?>
		<th data-name="sn" class="<?php echo $products->sn->HeaderCellClass() ?>"><div id="elh_products_sn" class="products_sn"><div class="ewTableHeaderCaption"><?php echo $products->sn->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sn" class="<?php echo $products->sn->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->sn) ?>',1);"><div id="elh_products_sn" class="products_sn">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->sn->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->sn->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->sn->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($products->product_category->Visible) { // product_category ?>
	<?php if ($products->SortUrl($products->product_category) == "") { ?>
		<th data-name="product_category" class="<?php echo $products->product_category->HeaderCellClass() ?>"><div id="elh_products_product_category" class="products_product_category"><div class="ewTableHeaderCaption"><?php echo $products->product_category->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="product_category" class="<?php echo $products->product_category->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->product_category) ?>',1);"><div id="elh_products_product_category" class="products_product_category">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->product_category->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($products->product_category->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->product_category->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($products->product_id->Visible) { // product_id ?>
	...
	<?php } else { ?>
		<th data-name="product_id" class="<?php echo $products->product_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->product_id) ?>',1);"><div id="elh_products_product_id" class="products_product_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->product_id->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($products->product_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->product_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($products->product_name->Visible) { // product_name ?>
	<?php if ($products->SortUrl($products->product_name) == "") { ?>
		<th data-name="product_name" class="<?php echo $products->product_name->HeaderCellClass() ?>"><div id="elh_products_product_name" class="products_product_name"><div class="ewTableHeaderCaption"><?php echo $products->product_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="product_name" class="<?php echo $products->product_name->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->product_name) ?>',1);"><div id="elh_products_product_name" class="products_product_name">
...
<?php if ($products->price->Visible) { // price ?>
	<?php if ($products->SortUrl($products->price) == "") { ?>
		<th data-name="price" class="<?php echo $products->price->HeaderCellClass() ?>"><div id="elh_products_price" class="products_price"><div class="ewTableHeaderCaption"><?php echo $products->price->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="price" class="<?php echo $products->price->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->price) ?>',1);"><div id="elh_products_price" class="products_price">
...
<?php if ($products->image->Visible) { // image ?>
	<?php if ($products->SortUrl($products->image) == "") { ?>
		<th data-name="image" class="<?php echo $products->image->HeaderCellClass() ?>"><div id="elh_products_image" class="products_image"><div class="ewTableHeaderCaption"><?php echo $products->image->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="image" class="<?php echo $products->image->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $products->SortUrl($products->image) ?>',1);"><div id="elh_products_image" class="products_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $products->image->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($products->image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($products->image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($products->sn->Visible) { // sn ?>
		<td data-name="sn"<?php echo $products->sn->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_sn" class="products_sn">
<span<?php echo $products->sn->ViewAttributes() ?>>
<?php echo $products->sn->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->product_category->Visible) { // product_category ?>
		<td data-name="product_category"<?php echo $products->product_category->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_product_category" class="products_product_category">
<span<?php echo $products->product_category->ViewAttributes() ?>>
<?php echo $products->product_category->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($products->product_id->Visible) { // product_id ?>
...
<?php echo $products->product_name->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($products->price->Visible) { // price ?>
		<td data-name="price"<?php echo $products->price->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_price" class="products_price">
...
<?php echo $products->price->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($products->image->Visible) { // image ?>
		<td data-name="image"<?php echo $products->image->CellAttributes() ?>>
<span id="el<?php echo $products_list->RowCnt ?>_products_image" class="products_image">
<span>
<?php echo ew_GetFileViewTag($products->image, $products->image->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
