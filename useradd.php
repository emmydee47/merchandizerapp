...
class cuser_add extends cuser {
	...
	function LoadDefaultValues() {
		...
		$this->user_code->CurrentValue = NULL;
		$this->user_code->OldValue = $this->user_code->CurrentValue;
		$this->device_token->CurrentValue = NULL;
		$this->device_token->OldValue = $this->device_token->CurrentValue;
		...
		$this->store_location->CurrentValue = NULL;
		$this->store_location->OldValue = $this->store_location->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['user_code'] = $this->user_code->CurrentValue;
		$row['device_token'] = $this->device_token->CurrentValue;
		$row['user_level'] = $this->user_level->CurrentValue;
		$row['profile'] = $this->profile->CurrentValue;
		$row['store_location'] = $this->store_location->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// Check if valid User ID
		$bValidUser = FALSE;
		if ($Security->CurrentUserID() <> "" && !ew_Empty($this->sn->CurrentValue) && !$Security->IsAdmin()) { // Non system admin
			$bValidUser = $Security->IsValidUserID($this->sn->CurrentValue);
			if (!$bValidUser) {
				$sUserIdMsg = str_replace("%c", CurrentUserID(), $Language->Phrase("UnAuthorizedUserID"));
				$sUserIdMsg = str_replace("%u", $this->sn->CurrentValue, $sUserIdMsg);
				$this->setFailureMessage($sUserIdMsg);
				return FALSE;
			}
		}
		...
		// user_type
		$this->user_type->SetDbValueDef($rsnew, $this->user_type->CurrentValue, "", FALSE);

		// user_code
		$this->user_code->SetDbValueDef($rsnew, $this->user_code->CurrentValue, "", FALSE);

		// device_token
		$this->device_token->SetDbValueDef($rsnew, $this->device_token->CurrentValue, "", FALSE);
		...
		// store_location
		$this->store_location->SetDbValueDef($rsnew, $this->store_location->CurrentValue, 0, FALSE);
...
fuseradd.Lists["x_user_level"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fuseradd.Lists["x_user_level"].Data = "<?php echo $user_add->user_level->LookupFilterQuery(FALSE, "add") ?>";
fuseradd.Lists["x_store_location"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_store_name","x_State","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"stores"};
fuseradd.Lists["x_store_location"].Data = "<?php echo $user_add->store_location->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($user->firstname->Visible) { // firstname ?>
	<div id="r_firstname" class="form-group">
		<label id="elh_user_firstname" for="x_firstname" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->firstname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->firstname->CellAttributes() ?>>
...
<?php if ($user->lastname->Visible) { // lastname ?>
	<div id="r_lastname" class="form-group">
		<label id="elh_user_lastname" for="x_lastname" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->lastname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->lastname->CellAttributes() ?>>
...
<?php if ($user->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_user__email" for="x__email" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($user->user_type->Visible) { // user_type ?>
	<div id="r_user_type" class="form-group">
		<label id="elh_user_user_type" for="x_user_type" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->user_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->user_type->CellAttributes() ?>>
...
<?php if ($user->user_code->Visible) { // user_code ?>
	<div id="r_user_code" class="form-group">
		<label id="elh_user_user_code" for="x_user_code" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->user_code->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->user_code->CellAttributes() ?>>
...
<?php if ($user->device_token->Visible) { // device_token ?>
	<div id="r_device_token" class="form-group">
		<label id="elh_user_device_token" for="x_device_token" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->device_token->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->device_token->CellAttributes() ?>>
...
<?php if ($user->user_level->Visible) { // user_level ?>
	<div id="r_user_level" class="form-group">
		<label id="elh_user_user_level" for="x_user_level" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->user_level->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->user_level->CellAttributes() ?>>
...
<?php if ($user->profile->Visible) { // profile ?>
	<div id="r_profile" class="form-group">
		<label id="elh_user_profile" for="x_profile" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->profile->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->profile->CellAttributes() ?>>
...
<?php if ($user->store_location->Visible) { // store_location ?>
	<div id="r_store_location" class="form-group">
		<label id="elh_user_store_location" for="x_store_location" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->store_location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $user_add->RightColumnClass ?>"><div<?php echo $user->store_location->CellAttributes() ?>>
