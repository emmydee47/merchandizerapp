...
class ccontent_add extends ccontent {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "contentview.php")
	...
	function LoadDefaultValues() {
		...
		$this->content_title->CurrentValue = NULL;
		$this->content_title->OldValue = $this->content_title->CurrentValue;
	...
	function NewRow() {
		...
		$row['content_title'] = $this->content_title->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// content_title
		$this->content_title->SetDbValueDef($rsnew, $this->content_title->CurrentValue, "", FALSE);
...
var CurrentForm = fcontentadd = new ew_Form("fcontentadd", "add");
...
fcontentadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fcontentadd" id="fcontentadd" class="<?php echo $content_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($content_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $content_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="content">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($content_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($content->content_title->Visible) { // content_title ?>
	<div id="r_content_title" class="form-group">
		<label id="elh_content_content_title" for="x_content_title" class="<?php echo $content_add->LeftColumnClass ?>"><?php echo $content->content_title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $content_add->RightColumnClass ?>"><div<?php echo $content->content_title->CellAttributes() ?>>
...
<?php if ($content->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_content_description" class="<?php echo $content_add->LeftColumnClass ?>"><?php echo $content->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $content_add->RightColumnClass ?>"><div<?php echo $content->description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcontentadd", "x_description", 0, 0, <?php echo ($content->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($content->file->Visible) { // file ?>
	<div id="r_file" class="form-group">
		<label id="elh_content_file" class="<?php echo $content_add->LeftColumnClass ?>"><?php echo $content->file->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $content_add->RightColumnClass ?>"><div<?php echo $content->file->CellAttributes() ?>>
...
<?php if (!$content_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $content_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $content_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
