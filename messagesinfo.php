...
class cmessages extends cTable {
	...
	function __construct() {
		...
		// sn
		$this->sn = new cField('messages', 'messages', 'x_sn', 'sn', '`sn`', '`sn`', 3, -1, FALSE, '`sn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->sn->Sortable = TRUE; // Allow sort
		$this->sn->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sn'] = &$this->sn;

		// message_title
		$this->message_title = new cField('messages', 'messages', 'x_message_title', 'message_title', '`message_title`', '`message_title`', 200, -1, FALSE, '`message_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->message_title->Sortable = TRUE; // Allow sort
		$this->fields['message_title'] = &$this->message_title;

		// message_body
		$this->message_body = new cField('messages', 'messages', 'x_message_body', 'message_body', '`message_body`', '`message_body`', 201, -1, FALSE, '`message_body`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->message_body->Sortable = TRUE; // Allow sort
		$this->fields['message_body'] = &$this->message_body;

		// sender
		$this->sender = new cField('messages', 'messages', 'x_sender', 'sender', '`sender`', '`sender`', 3, -1, FALSE, '`sender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->sender->Sortable = TRUE; // Allow sort
		$this->sender->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->sender->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->sender->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sender'] = &$this->sender;

		// receiver
		$this->receiver = new cField('messages', 'messages', 'x_receiver', 'receiver', '`receiver`', '`receiver`', 3, -1, FALSE, '`receiver`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->receiver->Sortable = TRUE; // Allow sort
		$this->receiver->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->receiver->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->receiver->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['receiver'] = &$this->receiver;

		// message_date
		$this->message_date = new cField('messages', 'messages', 'x_message_date', 'message_date', '`message_date`', ew_CastDateFieldForLike('`message_date`', 0, "DB"), 135, 0, FALSE, '`message_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->message_date->Sortable = TRUE; // Allow sort
		$this->message_date->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['message_date'] = &$this->message_date;

		// message_status
		$this->message_status = new cField('messages', 'messages', 'x_message_status', 'message_status', '`message_status`', '`message_status`', 200, -1, FALSE, '`message_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->message_status->Sortable = FALSE; // Allow sort
		$this->fields['message_status'] = &$this->message_status;
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "messagesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "messagesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("messagesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("messagesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "messagesadd.php?" . $this->UrlParm($parm);
		else
			$url = "messagesadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("messagesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("messagesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->message_title->setDbValue($rs->fields('message_title'));
		$this->message_body->setDbValue($rs->fields('message_body'));
		$this->sender->setDbValue($rs->fields('sender'));
		$this->receiver->setDbValue($rs->fields('receiver'));
		$this->message_date->setDbValue($rs->fields('message_date'));
		$this->message_status->setDbValue($rs->fields('message_status'));
	}
	...
	// Common render codes
		...
		// message_status
		$this->message_status->ViewValue = $this->message_status->CurrentValue;
		$this->message_status->ViewCustomAttributes = "";
		...
		// message_status
		$this->message_status->LinkCustomAttributes = "";
		$this->message_status->HrefValue = "";
		$this->message_status->TooltipValue = "";
	...
	function RenderEditRow() {
		...
		$this->message_title->EditValue = $this->message_title->CurrentValue;
		...
		$this->message_body->EditValue = $this->message_body->CurrentValue;
		...
		$this->message_status->EditAttrs["class"] = "form-control";
		$this->message_status->EditCustomAttributes = "";
		$this->message_status->EditValue = $this->message_status->CurrentValue;
		$this->message_status->PlaceHolder = ew_RemoveHtml($this->message_status->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->message_title->Exportable) $Doc->ExportCaption($this->message_title);
					if ($this->message_body->Exportable) $Doc->ExportCaption($this->message_body);
					if ($this->sender->Exportable) $Doc->ExportCaption($this->sender);
					if ($this->receiver->Exportable) $Doc->ExportCaption($this->receiver);
					if ($this->message_date->Exportable) $Doc->ExportCaption($this->message_date);
				} else {
					if ($this->sn->Exportable) $Doc->ExportCaption($this->sn);
					if ($this->message_title->Exportable) $Doc->ExportCaption($this->message_title);
					if ($this->sender->Exportable) $Doc->ExportCaption($this->sender);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->message_title->Exportable) $Doc->ExportField($this->message_title);
						if ($this->message_body->Exportable) $Doc->ExportField($this->message_body);
						if ($this->sender->Exportable) $Doc->ExportField($this->sender);
						if ($this->receiver->Exportable) $Doc->ExportField($this->receiver);
						if ($this->message_date->Exportable) $Doc->ExportField($this->message_date);
					} else {
						if ($this->sn->Exportable) $Doc->ExportField($this->sn);
						if ($this->message_title->Exportable) $Doc->ExportField($this->message_title);
						if ($this->sender->Exportable) $Doc->ExportField($this->sender);
