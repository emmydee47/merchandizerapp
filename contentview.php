	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["sn"] <> "") {
				...
				$sReturnUrl = "contentlist.php"; // Return to list
			}
...
var CurrentForm = fcontentview = new ew_Form("fcontentview", "view");
...
fcontentview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fcontentview" id="fcontentview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($content_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $content_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="content">
<input type="hidden" name="modal" value="<?php echo intval($content_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($content->sn->Visible) { // sn ?>
	<tr id="r_sn">
		<td class="col-sm-2"><span id="elh_content_sn"><?php echo $content->sn->FldCaption() ?></span></td>
		<td data-name="sn"<?php echo $content->sn->CellAttributes() ?>>
<span id="el_content_sn">
<span<?php echo $content->sn->ViewAttributes() ?>>
<?php echo $content->sn->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($content->content_title->Visible) { // content_title ?>
	<tr id="r_content_title">
		<td class="col-sm-2"><span id="elh_content_content_title"><?php echo $content->content_title->FldCaption() ?></span></td>
...
<?php echo $content->content_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($content->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_content_description"><?php echo $content->description->FldCaption() ?></span></td>
...
<?php echo $content->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($content->file->Visible) { // file ?>
	<tr id="r_file">
		<td class="col-sm-2"><span id="elh_content_file"><?php echo $content->file->FldCaption() ?></span></td>
		<td data-name="file"<?php echo $content->file->CellAttributes() ?>>
<span id="el_content_file">
<span<?php echo $content->file->ViewAttributes() ?>>
<?php echo ew_GetFileViewTag($content->file, $content->file->ViewValue) ?>
</span>
</span>
</td>
	</tr>
