...
class cstores_list extends cstores {
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_State") && $objForm->HasValue("o_State") && $this->State->CurrentValue <> $this->State->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_store_name") && $objForm->HasValue("o_store_name") && $this->store_name->CurrentValue <> $this->store_name->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fstoreslistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
	...
	function LoadFormValues() {
		...
		$this->State->setOldValue($objForm->GetValue("o_State"));
		if (!$this->store_name->FldIsDetailKey) {
			$this->store_name->setFormValue($objForm->GetValue("x_store_name"));
		}
		$this->store_name->setOldValue($objForm->GetValue("o_store_name"));
	}
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_stores\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_stores',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fstoreslist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Check empty row
fstoreslist.EmptyRow = function(infix) {
	var fobj = this.Form;
	if (ew_ValueChanged(fobj, infix, "State", false)) return false;
	if (ew_ValueChanged(fobj, infix, "store_name", false)) return false;
	return true;
}
...
fstoreslist.Lists["x_State"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstoreslist.Lists["x_State"].Options = <?php echo json_encode($stores_list->State->Options()) ?>;
...
if ($stores->CurrentAction == "gridadd") {
	$stores->CurrentFilter = "0=1";
	$stores_list->StartRec = 1;
	$stores_list->DisplayRecs = $stores->GridAddRowCount;
	$stores_list->TotalRecs = $stores_list->DisplayRecs;
	$stores_list->StopRec = $stores_list->DisplayRecs;
} else {
...
<?php if ($stores->sn->Visible) { // sn ?>
	<?php if ($stores->SortUrl($stores->sn) == "") { ?>
		<th data-name="sn" class="<?php echo $stores->sn->HeaderCellClass() ?>"><div id="elh_stores_sn" class="stores_sn"><div class="ewTableHeaderCaption"><?php echo $stores->sn->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sn" class="<?php echo $stores->sn->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $stores->SortUrl($stores->sn) ?>',1);"><div id="elh_stores_sn" class="stores_sn">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $stores->sn->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($stores->sn->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($stores->sn->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($stores->State->Visible) { // State ?>
	<?php if ($stores->SortUrl($stores->State) == "") { ?>
		<th data-name="State" class="<?php echo $stores->State->HeaderCellClass() ?>"><div id="elh_stores_State" class="stores_State"><div class="ewTableHeaderCaption"><?php echo $stores->State->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="State" class="<?php echo $stores->State->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $stores->SortUrl($stores->State) ?>',1);"><div id="elh_stores_State" class="stores_State">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $stores->State->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($stores->State->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($stores->State->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($stores->store_name->Visible) { // store_name ?>
	<?php if ($stores->SortUrl($stores->store_name) == "") { ?>
		<th data-name="store_name" class="<?php echo $stores->store_name->HeaderCellClass() ?>"><div id="elh_stores_store_name" class="stores_store_name"><div class="ewTableHeaderCaption"><?php echo $stores->store_name->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="store_name" class="<?php echo $stores->store_name->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $stores->SortUrl($stores->store_name) ?>',1);"><div id="elh_stores_store_name" class="stores_store_name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $stores->store_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($stores->store_name->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($stores->store_name->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($stores_list->FormKeyCountName) && ($stores->CurrentAction == "gridadd" || $stores->CurrentAction == "gridedit" || $stores->CurrentAction == "F")) {
		$stores_list->KeyCount = $objForm->GetValue($stores_list->FormKeyCountName);
		$stores_list->StopRec = $stores_list->StartRec + $stores_list->KeyCount - 1;
	}
}
...
if ($stores->CurrentAction == "gridadd")
	$stores_list->RowIndex = 0;
if ($stores->CurrentAction == "gridedit")
	$stores_list->RowIndex = 0;
while ($stores_list->RecCnt < $stores_list->StopRec) {
	$stores_list->RecCnt++;
	if (intval($stores_list->RecCnt) >= intval($stores_list->StartRec)) {
		$stores_list->RowCnt++;
		if ($stores->CurrentAction == "gridadd" || $stores->CurrentAction == "gridedit" || $stores->CurrentAction == "F") {
			$stores_list->RowIndex++;
			$objForm->Index = $stores_list->RowIndex;
			if ($objForm->HasValue($stores_list->FormActionName))
				$stores_list->RowAction = strval($objForm->GetValue($stores_list->FormActionName));
			elseif ($stores->CurrentAction == "gridadd")
				$stores_list->RowAction = "insert";
			else
				$stores_list->RowAction = "";
		}
		...
		$stores->CssClass = "";
		if ($stores->CurrentAction == "gridadd") {
			$stores_list->LoadRowValues(); // Load default values
		} else {
			$stores_list->LoadRowValues($stores_list->Recordset); // Load row values
		}
		$stores->RowType = EW_ROWTYPE_VIEW; // Render view
		if ($stores->CurrentAction == "gridadd") // Grid add
			$stores->RowType = EW_ROWTYPE_ADD; // Render add
		if ($stores->CurrentAction == "gridadd" && $stores->EventCancelled && !$objForm->HasValue("k_blankrow")) // Insert failed
			$stores_list->RestoreCurrentRowFormValues($stores_list->RowIndex); // Restore form values
		if ($stores->CurrentAction == "gridedit") { // Grid edit
			if ($stores->EventCancelled) {
				$stores_list->RestoreCurrentRowFormValues($stores_list->RowIndex); // Restore form values
			}
			if ($stores_list->RowAction == "insert")
				$stores->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$stores->RowType = EW_ROWTYPE_EDIT; // Render edit
		}
		if ($stores->CurrentAction == "gridedit" && ($stores->RowType == EW_ROWTYPE_EDIT || $stores->RowType == EW_ROWTYPE_ADD) && $stores->EventCancelled) // Update failed
			$stores_list->RestoreCurrentRowFormValues($stores_list->RowIndex); // Restore form values
		if ($stores->RowType == EW_ROWTYPE_EDIT) // Edit row
			$stores_list->EditRowCnt++;
		...
		if ($stores_list->RowAction <> "delete" && $stores_list->RowAction <> "insertdelete" && !($stores_list->RowAction == "insert" && $stores->CurrentAction == "F" && $stores_list->EmptyRow())) {
?>
...
<?php if ($stores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="stores" data-field="x_sn" name="o<?php echo $stores_list->RowIndex ?>_sn" id="o<?php echo $stores_list->RowIndex ?>_sn" value="<?php echo ew_HtmlEncode($stores->sn->OldValue) ?>">
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_sn" class="form-group stores_sn">
<span<?php echo $stores->sn->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $stores->sn->EditValue ?></p></span>
</span>
<input type="hidden" data-table="stores" data-field="x_sn" name="x<?php echo $stores_list->RowIndex ?>_sn" id="x<?php echo $stores_list->RowIndex ?>_sn" value="<?php echo ew_HtmlEncode($stores->sn->CurrentValue) ?>">
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_sn" class="stores_sn">
<span<?php echo $stores->sn->ViewAttributes() ?>>
...
<?php if ($stores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_State" class="form-group stores_State">
<select data-table="stores" data-field="x_State" data-value-separator="<?php echo $stores->State->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $stores_list->RowIndex ?>_State" name="x<?php echo $stores_list->RowIndex ?>_State"<?php echo $stores->State->EditAttributes() ?>>
<?php echo $stores->State->SelectOptionListHtml("x<?php echo $stores_list->RowIndex ?>_State") ?>
</select>
</span>
<input type="hidden" data-table="stores" data-field="x_State" name="o<?php echo $stores_list->RowIndex ?>_State" id="o<?php echo $stores_list->RowIndex ?>_State" value="<?php echo ew_HtmlEncode($stores->State->OldValue) ?>">
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_State" class="form-group stores_State">
<select data-table="stores" data-field="x_State" data-value-separator="<?php echo $stores->State->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $stores_list->RowIndex ?>_State" name="x<?php echo $stores_list->RowIndex ?>_State"<?php echo $stores->State->EditAttributes() ?>>
...
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_State" class="stores_State">
...
<?php if ($stores->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_store_name" class="form-group stores_store_name">
<input type="text" data-table="stores" data-field="x_store_name" name="x<?php echo $stores_list->RowIndex ?>_store_name" id="x<?php echo $stores_list->RowIndex ?>_store_name" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($stores->store_name->getPlaceHolder()) ?>" value="<?php echo $stores->store_name->EditValue ?>"<?php echo $stores->store_name->EditAttributes() ?>>
</span>
<input type="hidden" data-table="stores" data-field="x_store_name" name="o<?php echo $stores_list->RowIndex ?>_store_name" id="o<?php echo $stores_list->RowIndex ?>_store_name" value="<?php echo ew_HtmlEncode($stores->store_name->OldValue) ?>">
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_store_name" class="form-group stores_store_name">
<input type="text" data-table="stores" data-field="x_store_name" name="x<?php echo $stores_list->RowIndex ?>_store_name" id="x<?php echo $stores_list->RowIndex ?>_store_name" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($stores->store_name->getPlaceHolder()) ?>" value="<?php echo $stores->store_name->EditValue ?>"<?php echo $stores->store_name->EditAttributes() ?>>
...
<?php } ?>
<?php if ($stores->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $stores_list->RowCnt ?>_stores_store_name" class="stores_store_name">
...
<?php if ($stores->RowType == EW_ROWTYPE_ADD || $stores->RowType == EW_ROWTYPE_EDIT) { ?>
<script type="text/javascript">
fstoreslist.UpdateOpts(<?php echo $stores_list->RowIndex ?>);
</script>
<?php } ?>
<?php
	}
	...
	if ($stores->CurrentAction <> "gridadd")
		if (!$stores_list->Recordset->EOF) $stores_list->Recordset->MoveNext();
}
?>
<?php
	if ($stores->CurrentAction == "gridadd" || $stores->CurrentAction == "gridedit") {
		$stores_list->RowIndex = '$rowindex$';
		$stores_list->LoadRowValues();

		// Set row properties
		$stores->ResetAttrs();
		$stores->RowAttrs = array_merge($stores->RowAttrs, array('data-rowindex'=>$stores_list->RowIndex, 'id'=>'r0_stores', 'data-rowtype'=>EW_ROWTYPE_ADD));
		ew_AppendClass($stores->RowAttrs["class"], "ewTemplate");
		$stores->RowType = EW_ROWTYPE_ADD;
		...
		// Render list options
		$stores_list->RenderListOptions();
		$stores_list->StartRowCnt = 0;
?>
	<tr<?php echo $stores->RowAttributes() ?>>
<?php

// Render list options (body, left)
$stores_list->ListOptions->Render("body", "left", $stores_list->RowIndex);
?>
	<?php if ($stores->sn->Visible) { // sn ?>
		<td data-name="sn">
<input type="hidden" data-table="stores" data-field="x_sn" name="o<?php echo $stores_list->RowIndex ?>_sn" id="o<?php echo $stores_list->RowIndex ?>_sn" value="<?php echo ew_HtmlEncode($stores->sn->OldValue) ?>">
	...
	<?php if ($stores->State->Visible) { // State ?>
		<td data-name="State">
<span id="el$rowindex$_stores_State" class="form-group stores_State">
<select data-table="stores" data-field="x_State" data-value-separator="<?php echo $stores->State->DisplayValueSeparatorAttribute() ?>" id="x<?php echo $stores_list->RowIndex ?>_State" name="x<?php echo $stores_list->RowIndex ?>_State"<?php echo $stores->State->EditAttributes() ?>>
<?php echo $stores->State->SelectOptionListHtml("x<?php echo $stores_list->RowIndex ?>_State") ?>
</select>
</span>
<input type="hidden" data-table="stores" data-field="x_State" name="o<?php echo $stores_list->RowIndex ?>_State" id="o<?php echo $stores_list->RowIndex ?>_State" value="<?php echo ew_HtmlEncode($stores->State->OldValue) ?>">
	...
	<?php } ?>
	<?php if ($stores->store_name->Visible) { // store_name ?>
		<td data-name="store_name">
<span id="el$rowindex$_stores_store_name" class="form-group stores_store_name">
<input type="text" data-table="stores" data-field="x_store_name" name="x<?php echo $stores_list->RowIndex ?>_store_name" id="x<?php echo $stores_list->RowIndex ?>_store_name" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($stores->store_name->getPlaceHolder()) ?>" value="<?php echo $stores->store_name->EditValue ?>"<?php echo $stores->store_name->EditAttributes() ?>>
</span>
<input type="hidden" data-table="stores" data-field="x_store_name" name="o<?php echo $stores_list->RowIndex ?>_store_name" id="o<?php echo $stores_list->RowIndex ?>_store_name" value="<?php echo ew_HtmlEncode($stores->store_name->OldValue) ?>">
</td>
...
<?php } ?>
<?php if ($stores->CurrentAction == "gridadd") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridinsert">
<input type="hidden" name="<?php echo $stores_list->FormKeyCountName ?>" id="<?php echo $stores_list->FormKeyCountName ?>" value="<?php echo $stores_list->KeyCount ?>">
<?php echo $stores_list->MultiSelectKey ?>
<?php } ?>
<?php if ($stores->CurrentAction == "gridedit") { ?>
...
<option value="10"<?php if ($stores_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
