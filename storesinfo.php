...
class cstores extends cTable {
	...
	function __construct() {
		...
		// sn
		$this->sn = new cField('stores', 'stores', 'x_sn', 'sn', '`sn`', '`sn`', 3, -1, FALSE, '`sn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->sn->Sortable = TRUE; // Allow sort
		$this->sn->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sn'] = &$this->sn;

		// State
		$this->State = new cField('stores', 'stores', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// store_name
		$this->store_name = new cField('stores', 'stores', 'x_store_name', 'store_name', '`store_name`', '`store_name`', 200, -1, FALSE, '`store_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->store_name->Sortable = TRUE; // Allow sort
		$this->fields['store_name'] = &$this->store_name;

		// address
		$this->address = new cField('stores', 'stores', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
