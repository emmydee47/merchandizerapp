...
fproductsdelete.Lists["x_product_category"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"product_categories"};
fproductsdelete.Lists["x_product_category"].Data = "<?php echo $products_delete->product_category->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($products->sn->Visible) { // sn ?>
		<th class="<?php echo $products->sn->HeaderCellClass() ?>"><span id="elh_products_sn" class="products_sn"><?php echo $products->sn->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->product_category->Visible) { // product_category ?>
		<th class="<?php echo $products->product_category->HeaderCellClass() ?>"><span id="elh_products_product_category" class="products_product_category"><?php echo $products->product_category->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($products->product_name->Visible) { // product_name ?>
		<th class="<?php echo $products->product_name->HeaderCellClass() ?>"><span id="elh_products_product_name" class="products_product_name"><?php echo $products->product_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->price->Visible) { // price ?>
		<th class="<?php echo $products->price->HeaderCellClass() ?>"><span id="elh_products_price" class="products_price"><?php echo $products->price->FldCaption() ?></span></th>
<?php } ?>
<?php if ($products->image->Visible) { // image ?>
		<th class="<?php echo $products->image->HeaderCellClass() ?>"><span id="elh_products_image" class="products_image"><?php echo $products->image->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($products->sn->Visible) { // sn ?>
		<td<?php echo $products->sn->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_sn" class="products_sn">
...
<?php } ?>
<?php if ($products->product_category->Visible) { // product_category ?>
		<td<?php echo $products->product_category->CellAttributes() ?>>
<span id="el<?php echo $products_delete->RowCnt ?>_products_product_category" class="products_product_category">
...
<span id="el<?php echo $products_delete->RowCnt ?>_products_price" class="products_price">
...
<span id="el<?php echo $products_delete->RowCnt ?>_products_image" class="products_image">
<span>
