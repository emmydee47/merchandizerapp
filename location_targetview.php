...
$location_target_view = NULL; // Initialize page object first

class clocation_target_view extends clocation_target {
	...
	// Page object name
	var $PageObjName = 'location_target_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["sn"] <> "") {
				...
				$sReturnUrl = "location_targetlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "location_targetlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "location_targetlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($location_target_view)) $location_target_view = new clocation_target_view();

// Page init
$location_target_view->Page_Init();

// Page main
$location_target_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$location_target_view->Page_Render();
?>
...
var CurrentForm = flocation_targetview = new ew_Form("flocation_targetview", "view");

// Form_CustomValidate event
flocation_targetview.Form_CustomValidate = 
...
flocation_targetview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flocation_targetview.Lists["x_location"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_store_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"stores"};
flocation_targetview.Lists["x_location"].Data = "<?php echo $location_target_view->location->LookupFilterQuery(FALSE, "view") ?>";
flocation_targetview.Lists["x_month"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flocation_targetview.Lists["x_month"].Options = <?php echo json_encode($location_target_view->month->Options()) ?>;
flocation_targetview.Lists["x_product_category"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"product_categories"};
flocation_targetview.Lists["x_product_category"].Data = "<?php echo $location_target_view->product_category->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $location_target_view->ExportOptions->Render("body") ?>
<?php
	foreach ($location_target_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $location_target_view->ShowPageHeader(); ?>
<?php
$location_target_view->ShowMessage();
?>
<form name="flocation_targetview" id="flocation_targetview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($location_target_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $location_target_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="location_target">
<input type="hidden" name="modal" value="<?php echo intval($location_target_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($location_target->sn->Visible) { // sn ?>
	<tr id="r_sn">
		<td class="col-sm-2"><span id="elh_location_target_sn"><?php echo $location_target->sn->FldCaption() ?></span></td>
...
<?php echo $location_target->sn->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($location_target->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_location_target_date"><?php echo $location_target->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $location_target->date->CellAttributes() ?>>
<span id="el_location_target_date">
<span<?php echo $location_target->date->ViewAttributes() ?>>
<?php echo $location_target->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($location_target->location->Visible) { // location ?>
	<tr id="r_location">
		<td class="col-sm-2"><span id="elh_location_target_location"><?php echo $location_target->location->FldCaption() ?></span></td>
...
<?php echo $location_target->location->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($location_target->month->Visible) { // month ?>
	<tr id="r_month">
		<td class="col-sm-2"><span id="elh_location_target_month"><?php echo $location_target->month->FldCaption() ?></span></td>
...
<?php echo $location_target->month->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($location_target->product_category->Visible) { // product_category ?>
	<tr id="r_product_category">
		<td class="col-sm-2"><span id="elh_location_target_product_category"><?php echo $location_target->product_category->FldCaption() ?></span></td>
...
<?php echo $location_target->product_category->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($location_target->target_value->Visible) { // target_value ?>
	<tr id="r_target_value">
		<td class="col-sm-2"><span id="elh_location_target_target_value"><?php echo $location_target->target_value->FldCaption() ?></span></td>
...
<?php echo $location_target->target_value->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
flocation_targetview.Init();
</script>
<?php
$location_target_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$location_target_view->Page_Terminate();
?>
