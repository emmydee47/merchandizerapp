...
$transactions_edit = NULL; // Initialize page object first

class ctransactions_edit extends ctransactions {
	...
	// Page object name
	var $PageObjName = 'transactions_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// receipt_number
			$this->receipt_number->SetDbValueDef($rsnew, $this->receipt_number->CurrentValue, "", $this->receipt_number->ReadOnly);
...
// Create page object
if (!isset($transactions_edit)) $transactions_edit = new ctransactions_edit();

// Page init
$transactions_edit->Page_Init();

// Page main
$transactions_edit->Page_Main();
...
var CurrentForm = ftransactionsedit = new ew_Form("ftransactionsedit", "edit");
...
ftransactionsedit.Form_CustomValidate = 
...
ftransactionsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftransactionsedit.Lists["x_product"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_product_name","x_product_id","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"products"};
ftransactionsedit.Lists["x_product"].Data = "<?php echo $transactions_edit->product->LookupFilterQuery(FALSE, "edit") ?>";
ftransactionsedit.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftransactionsedit.Lists["x_status"].Options = <?php echo json_encode($transactions_edit->status->Options()) ?>;
...
<?php $transactions_edit->ShowPageHeader(); ?>
<?php
$transactions_edit->ShowMessage();
?>
<form name="ftransactionsedit" id="ftransactionsedit" class="<?php echo $transactions_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($transactions_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $transactions_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="transactions">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($transactions_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($transactions->sn->Visible) { // sn ?>
	<div id="r_sn" class="form-group">
		<label id="elh_transactions_sn" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->sn->FldCaption() ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->sn->CellAttributes() ?>>
<span id="el_transactions_sn">
<span<?php echo $transactions->sn->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $transactions->sn->EditValue ?></p></span>
</span>
<input type="hidden" data-table="transactions" data-field="x_sn" name="x_sn" id="x_sn" value="<?php echo ew_HtmlEncode($transactions->sn->CurrentValue) ?>">
<?php echo $transactions->sn->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($transactions->receipt_number->Visible) { // receipt_number ?>
	<div id="r_receipt_number" class="form-group">
		<label id="elh_transactions_receipt_number" for="x_receipt_number" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->receipt_number->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->receipt_number->CellAttributes() ?>>
...
<?php if ($transactions->product->Visible) { // product ?>
	<div id="r_product" class="form-group">
		<label id="elh_transactions_product" for="x_product" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->product->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->product->CellAttributes() ?>>
...
<?php if ($transactions->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group">
		<label id="elh_transactions_amount" for="x_amount" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->amount->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->amount->CellAttributes() ?>>
...
<?php if ($transactions->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_transactions_quantity" for="x_quantity" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->quantity->CellAttributes() ?>>
...
<?php if ($transactions->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_transactions_status" class="<?php echo $transactions_edit->LeftColumnClass ?>"><?php echo $transactions->status->FldCaption() ?></label>
		<div class="<?php echo $transactions_edit->RightColumnClass ?>"><div<?php echo $transactions->status->CellAttributes() ?>>
...
<?php echo $transactions->status->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$transactions_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $transactions_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $transactions_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ftransactionsedit.Init();
</script>
<?php
...
<?php
$transactions_edit->Page_Terminate();
?>
