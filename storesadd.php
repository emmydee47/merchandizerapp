...
class cstores_add extends cstores {
	...
	function LoadDefaultValues() {
		...
		$this->store_name->CurrentValue = NULL;
		$this->store_name->OldValue = $this->store_name->CurrentValue;
	...
	function NewRow() {
		...
		$row['store_name'] = $this->store_name->CurrentValue;
...
fstoresadd.Lists["x_State"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstoresadd.Lists["x_State"].Options = <?php echo json_encode($stores_add->State->Options()) ?>;
...
<?php if ($stores->State->Visible) { // State ?>
	<div id="r_State" class="form-group">
		<label id="elh_stores_State" for="x_State" class="<?php echo $stores_add->LeftColumnClass ?>"><?php echo $stores->State->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $stores_add->RightColumnClass ?>"><div<?php echo $stores->State->CellAttributes() ?>>
...
<?php if ($stores->store_name->Visible) { // store_name ?>
	<div id="r_store_name" class="form-group">
		<label id="elh_stores_store_name" for="x_store_name" class="<?php echo $stores_add->LeftColumnClass ?>"><?php echo $stores->store_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $stores_add->RightColumnClass ?>"><div<?php echo $stores->store_name->CellAttributes() ?>>
