...
define("EW_PROJECT_NAME", "Merchandizer", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{B6A7A568-E606-4B9C-A82F-C80372444DA0}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'adRKh7zaHq18dB2V', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Merchandizer.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "merchdb", "qs" => "`", "qe" => "`");
...
define("EW_ALLOW_LOGIN_BY_URL", TRUE, TRUE); // Allow login by URL
...
define("EW_USER_ID_FILTER", "(`sn` = %u)", TRUE);
