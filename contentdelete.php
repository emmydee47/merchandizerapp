	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("contentlist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fcontentdelete = new ew_Form("fcontentdelete", "delete");
...
fcontentdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<form name="fcontentdelete" id="fcontentdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($content_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $content_delete->Token ?>">
<?php } ?>
...
<?php if ($content->sn->Visible) { // sn ?>
		<th class="<?php echo $content->sn->HeaderCellClass() ?>"><span id="elh_content_sn" class="content_sn"><?php echo $content->sn->FldCaption() ?></span></th>
<?php } ?>
<?php if ($content->content_title->Visible) { // content_title ?>
		<th class="<?php echo $content->content_title->HeaderCellClass() ?>"><span id="elh_content_content_title" class="content_content_title"><?php echo $content->content_title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($content->description->Visible) { // description ?>
		<th class="<?php echo $content->description->HeaderCellClass() ?>"><span id="elh_content_description" class="content_description"><?php echo $content->description->FldCaption() ?></span></th>
<?php } ?>
<?php if ($content->file->Visible) { // file ?>
		<th class="<?php echo $content->file->HeaderCellClass() ?>"><span id="elh_content_file" class="content_file"><?php echo $content->file->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($content->sn->Visible) { // sn ?>
		<td<?php echo $content->sn->CellAttributes() ?>>
<span id="el<?php echo $content_delete->RowCnt ?>_content_sn" class="content_sn">
...
<?php } ?>
<?php if ($content->content_title->Visible) { // content_title ?>
		<td<?php echo $content->content_title->CellAttributes() ?>>
<span id="el<?php echo $content_delete->RowCnt ?>_content_content_title" class="content_content_title">
...
<?php } ?>
<?php if ($content->description->Visible) { // description ?>
		<td<?php echo $content->description->CellAttributes() ?>>
<span id="el<?php echo $content_delete->RowCnt ?>_content_description" class="content_description">
...
<?php } ?>
<?php if ($content->file->Visible) { // file ?>
		<td<?php echo $content->file->CellAttributes() ?>>
<span id="el<?php echo $content_delete->RowCnt ?>_content_file" class="content_file">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $content_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fcontentdelete.Init();
