...
$product_categories_edit = NULL; // Initialize page object first

class cproduct_categories_edit extends cproduct_categories {
	...
	// Page object name
	var $PageObjName = 'product_categories_edit';
	...
	function RenderRow() {
		...
		$this->category_image->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->category_image);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// category_image
			if ($this->category_image->Visible && !$this->category_image->ReadOnly && !$this->category_image->Upload->KeepFile) {
				$this->category_image->Upload->DbValue = $rsold['category_image']; // Get original value
...
// Create page object
if (!isset($product_categories_edit)) $product_categories_edit = new cproduct_categories_edit();

// Page init
$product_categories_edit->Page_Init();

// Page main
$product_categories_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$product_categories_edit->Page_Render();
?>
...
var CurrentForm = fproduct_categoriesedit = new ew_Form("fproduct_categoriesedit", "edit");

// Validate form
fproduct_categoriesedit.Validate = function() {
...
fproduct_categoriesedit.Form_CustomValidate = 
...
fproduct_categoriesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $product_categories_edit->ShowPageHeader(); ?>
<?php
$product_categories_edit->ShowMessage();
?>
<form name="fproduct_categoriesedit" id="fproduct_categoriesedit" class="<?php echo $product_categories_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($product_categories_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $product_categories_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="product_categories">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($product_categories_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($product_categories->sn->Visible) { // sn ?>
	<div id="r_sn" class="form-group">
		<label id="elh_product_categories_sn" class="<?php echo $product_categories_edit->LeftColumnClass ?>"><?php echo $product_categories->sn->FldCaption() ?></label>
		<div class="<?php echo $product_categories_edit->RightColumnClass ?>"><div<?php echo $product_categories->sn->CellAttributes() ?>>
<span id="el_product_categories_sn">
<span<?php echo $product_categories->sn->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $product_categories->sn->EditValue ?></p></span>
</span>
<input type="hidden" data-table="product_categories" data-field="x_sn" name="x_sn" id="x_sn" value="<?php echo ew_HtmlEncode($product_categories->sn->CurrentValue) ?>">
<?php echo $product_categories->sn->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($product_categories->category->Visible) { // category ?>
	<div id="r_category" class="form-group">
		<label id="elh_product_categories_category" for="x_category" class="<?php echo $product_categories_edit->LeftColumnClass ?>"><?php echo $product_categories->category->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_categories_edit->RightColumnClass ?>"><div<?php echo $product_categories->category->CellAttributes() ?>>
...
<?php if ($product_categories->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_product_categories_description" for="x_description" class="<?php echo $product_categories_edit->LeftColumnClass ?>"><?php echo $product_categories->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_categories_edit->RightColumnClass ?>"><div<?php echo $product_categories->description->CellAttributes() ?>>
...
<?php if ($product_categories->category_image->Visible) { // category_image ?>
	<div id="r_category_image" class="form-group">
		<label id="elh_product_categories_category_image" class="<?php echo $product_categories_edit->LeftColumnClass ?>"><?php echo $product_categories->category_image->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $product_categories_edit->RightColumnClass ?>"><div<?php echo $product_categories->category_image->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_category_image"] == "0") { ?>
<input type="hidden" name="fa_x_category_image" id= "fa_x_category_image" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_category_image" id= "fa_x_category_image" value="1">
<?php } ?>
...
<?php if (!$product_categories_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $product_categories_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $product_categories_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fproduct_categoriesedit.Init();
</script>
<?php
$product_categories_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$product_categories_edit->Page_Terminate();
?>
