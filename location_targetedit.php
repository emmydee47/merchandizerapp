...
$location_target_edit = NULL; // Initialize page object first

class clocation_target_edit extends clocation_target {
	...
	// Page object name
	var $PageObjName = 'location_target_edit';
...
// Create page object
if (!isset($location_target_edit)) $location_target_edit = new clocation_target_edit();

// Page init
$location_target_edit->Page_Init();

// Page main
$location_target_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$location_target_edit->Page_Render();
?>
...
var CurrentForm = flocation_targetedit = new ew_Form("flocation_targetedit", "edit");

// Validate form
flocation_targetedit.Validate = function() {
...
flocation_targetedit.Form_CustomValidate = 
...
flocation_targetedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flocation_targetedit.Lists["x_location"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_store_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"stores"};
flocation_targetedit.Lists["x_location"].Data = "<?php echo $location_target_edit->location->LookupFilterQuery(FALSE, "edit") ?>";
flocation_targetedit.Lists["x_month"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flocation_targetedit.Lists["x_month"].Options = <?php echo json_encode($location_target_edit->month->Options()) ?>;
flocation_targetedit.Lists["x_product_category"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_category","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"product_categories"};
flocation_targetedit.Lists["x_product_category"].Data = "<?php echo $location_target_edit->product_category->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $location_target_edit->ShowPageHeader(); ?>
<?php
$location_target_edit->ShowMessage();
?>
<form name="flocation_targetedit" id="flocation_targetedit" class="<?php echo $location_target_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($location_target_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $location_target_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="location_target">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($location_target_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($location_target->sn->Visible) { // sn ?>
	<div id="r_sn" class="form-group">
		<label id="elh_location_target_sn" class="<?php echo $location_target_edit->LeftColumnClass ?>"><?php echo $location_target->sn->FldCaption() ?></label>
		<div class="<?php echo $location_target_edit->RightColumnClass ?>"><div<?php echo $location_target->sn->CellAttributes() ?>>
<span id="el_location_target_sn">
<span<?php echo $location_target->sn->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $location_target->sn->EditValue ?></p></span>
</span>
<input type="hidden" data-table="location_target" data-field="x_sn" name="x_sn" id="x_sn" value="<?php echo ew_HtmlEncode($location_target->sn->CurrentValue) ?>">
<?php echo $location_target->sn->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($location_target->location->Visible) { // location ?>
	<div id="r_location" class="form-group">
		<label id="elh_location_target_location" for="x_location" class="<?php echo $location_target_edit->LeftColumnClass ?>"><?php echo $location_target->location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $location_target_edit->RightColumnClass ?>"><div<?php echo $location_target->location->CellAttributes() ?>>
...
<?php if ($location_target->month->Visible) { // month ?>
	<div id="r_month" class="form-group">
		<label id="elh_location_target_month" for="x_month" class="<?php echo $location_target_edit->LeftColumnClass ?>"><?php echo $location_target->month->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $location_target_edit->RightColumnClass ?>"><div<?php echo $location_target->month->CellAttributes() ?>>
...
<?php if ($location_target->product_category->Visible) { // product_category ?>
	<div id="r_product_category" class="form-group">
		<label id="elh_location_target_product_category" for="x_product_category" class="<?php echo $location_target_edit->LeftColumnClass ?>"><?php echo $location_target->product_category->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $location_target_edit->RightColumnClass ?>"><div<?php echo $location_target->product_category->CellAttributes() ?>>
...
<?php if ($location_target->target_value->Visible) { // target_value ?>
	<div id="r_target_value" class="form-group">
		<label id="elh_location_target_target_value" for="x_target_value" class="<?php echo $location_target_edit->LeftColumnClass ?>"><?php echo $location_target->target_value->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $location_target_edit->RightColumnClass ?>"><div<?php echo $location_target->target_value->CellAttributes() ?>>
...
<?php if (!$location_target_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $location_target_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $location_target_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
flocation_targetedit.Init();
</script>
<?php
$location_target_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$location_target_edit->Page_Terminate();
?>
