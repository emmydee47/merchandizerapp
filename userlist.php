...
class cuser_list extends cuser {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fuserlistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
		...
		$sFilterList = ew_Concat($sFilterList, $this->user_type->AdvancedSearch->ToJson(), ","); // Field user_type
		$sFilterList = ew_Concat($sFilterList, $this->user_code->AdvancedSearch->ToJson(), ","); // Field user_code
		$sFilterList = ew_Concat($sFilterList, $this->device_token->AdvancedSearch->ToJson(), ","); // Field device_token
		...
		$sFilterList = ew_Concat($sFilterList, $this->store_location->AdvancedSearch->ToJson(), ","); // Field store_location
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field user_type
		$this->user_type->AdvancedSearch->SearchValue = @$filter["x_user_type"];
		$this->user_type->AdvancedSearch->SearchOperator = @$filter["z_user_type"];
		$this->user_type->AdvancedSearch->SearchCondition = @$filter["v_user_type"];
		$this->user_type->AdvancedSearch->SearchValue2 = @$filter["y_user_type"];
		$this->user_type->AdvancedSearch->SearchOperator2 = @$filter["w_user_type"];
		$this->user_type->AdvancedSearch->Save();

		// Field user_code
		$this->user_code->AdvancedSearch->SearchValue = @$filter["x_user_code"];
		$this->user_code->AdvancedSearch->SearchOperator = @$filter["z_user_code"];
		$this->user_code->AdvancedSearch->SearchCondition = @$filter["v_user_code"];
		$this->user_code->AdvancedSearch->SearchValue2 = @$filter["y_user_code"];
		$this->user_code->AdvancedSearch->SearchOperator2 = @$filter["w_user_code"];
		$this->user_code->AdvancedSearch->Save();

		// Field device_token
		$this->device_token->AdvancedSearch->SearchValue = @$filter["x_device_token"];
		$this->device_token->AdvancedSearch->SearchOperator = @$filter["z_device_token"];
		$this->device_token->AdvancedSearch->SearchCondition = @$filter["v_device_token"];
		$this->device_token->AdvancedSearch->SearchValue2 = @$filter["y_device_token"];
		$this->device_token->AdvancedSearch->SearchOperator2 = @$filter["w_device_token"];
		$this->device_token->AdvancedSearch->Save();
		...
		$this->store_location->AdvancedSearch->SearchValue = @$filter["x_store_location"];
		$this->store_location->AdvancedSearch->SearchOperator = @$filter["z_store_location"];
		$this->store_location->AdvancedSearch->SearchCondition = @$filter["v_store_location"];
		$this->store_location->AdvancedSearch->SearchValue2 = @$filter["y_store_location"];
		$this->store_location->AdvancedSearch->SearchOperator2 = @$filter["w_store_location"];
		$this->store_location->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->user_type, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->user_code, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->device_token, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->profile, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->store_location, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->user_type); // user_type
			$this->UpdateSort($this->store_location); // store_location
...
fuserlist.Lists["x_store_location"] = {"LinkField":"x_sn","Ajax":true,"AutoFill":false,"DisplayFields":["x_store_name","x_State","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"stores"};
fuserlist.Lists["x_store_location"].Data = "<?php echo $user_list->store_location->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($user->sn->Visible) { // sn ?>
	<?php if ($user->SortUrl($user->sn) == "") { ?>
		<th data-name="sn" class="<?php echo $user->sn->HeaderCellClass() ?>"><div id="elh_user_sn" class="user_sn"><div class="ewTableHeaderCaption"><?php echo $user->sn->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sn" class="<?php echo $user->sn->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->sn) ?>',1);"><div id="elh_user_sn" class="user_sn">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->sn->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->sn->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->sn->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user->firstname->Visible) { // firstname ?>
	<?php if ($user->SortUrl($user->firstname) == "") { ?>
		<th data-name="firstname" class="<?php echo $user->firstname->HeaderCellClass() ?>"><div id="elh_user_firstname" class="user_firstname"><div class="ewTableHeaderCaption"><?php echo $user->firstname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="firstname" class="<?php echo $user->firstname->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->firstname) ?>',1);"><div id="elh_user_firstname" class="user_firstname">
...
<?php if ($user->lastname->Visible) { // lastname ?>
	<?php if ($user->SortUrl($user->lastname) == "") { ?>
		<th data-name="lastname" class="<?php echo $user->lastname->HeaderCellClass() ?>"><div id="elh_user_lastname" class="user_lastname"><div class="ewTableHeaderCaption"><?php echo $user->lastname->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="lastname" class="<?php echo $user->lastname->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->lastname) ?>',1);"><div id="elh_user_lastname" class="user_lastname">
...
<?php if ($user->_email->Visible) { // email ?>
	...
	<?php } else { ?>
		<th data-name="_email" class="<?php echo $user->_email->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->_email) ?>',1);"><div id="elh_user__email" class="user__email">
...
<?php if ($user->user_type->Visible) { // user_type ?>
	<?php if ($user->SortUrl($user->user_type) == "") { ?>
		<th data-name="user_type" class="<?php echo $user->user_type->HeaderCellClass() ?>"><div id="elh_user_user_type" class="user_user_type"><div class="ewTableHeaderCaption"><?php echo $user->user_type->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="user_type" class="<?php echo $user->user_type->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->user_type) ?>',1);"><div id="elh_user_user_type" class="user_user_type">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->user_type->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->user_type->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->user_type->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($user->store_location->Visible) { // store_location ?>
	<?php if ($user->SortUrl($user->store_location) == "") { ?>
		<th data-name="store_location" class="<?php echo $user->store_location->HeaderCellClass() ?>"><div id="elh_user_store_location" class="user_store_location"><div class="ewTableHeaderCaption"><?php echo $user->store_location->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="store_location" class="<?php echo $user->store_location->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->store_location) ?>',1);"><div id="elh_user_store_location" class="user_store_location">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->store_location->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->store_location->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->store_location->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $user_list->RowCnt ?>_user_sn" class="user_sn">
...
<span id="el<?php echo $user_list->RowCnt ?>_user_firstname" class="user_firstname">
...
<span id="el<?php echo $user_list->RowCnt ?>_user_lastname" class="user_lastname">
...
<span id="el<?php echo $user_list->RowCnt ?>_user_user_type" class="user_user_type">
...
<span id="el<?php echo $user_list->RowCnt ?>_user_store_location" class="user_store_location">
